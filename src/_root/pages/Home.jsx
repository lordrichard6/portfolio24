...
const Home = () => {
  return (
    <>
      <header id="top" className='w-screen min-h-screen max-h-screen relative flex justify-center items-center py-24 mb-40'>
      ...
      <section className="who-am-i section-width-default min-h-screen w-full flex-centered relative mb-40">
        <div className="clipped-bg" />
        <div className="clipped-bg second" />
        <div className="z-10">
          <h1 className='mb-40'>Who am I?</h1>
          <div className="flex mb-40">
            ...
            <div className="">
              <img className='w-[280px] h-[280px] rounded-full object-cover' src="/src/assets/images/test.jpg" alt="" />
            </div>
          </div>
          <div className="flex-centered">
            <button className='btn-primary'>Know more</button>
            <button className='btn-social'><SlSocialLinkedin /></button>
            <button className='btn-social'><SlSocialInstagram /></button>
          </div>
        </div>
      ...
      <section className='featured-projects section-width-default min-h-screen w-full flex-centered relative mb-40'>
        ...
        <div className="z-10">
          ...
          <div className="project-container flex mb-40">
            <img className='w-[400px] h-[400px] object-cover' src="/src/assets/images/test.jpg" alt="" />
            <div className="ml-10">
              <h2>Project 1</h2>
          ...
          <div className="flex-centered mb-40">
            ...
            <button className='btn-social'><SiGithub /></button>
          </div>
        </div>
      </section>
    </>
